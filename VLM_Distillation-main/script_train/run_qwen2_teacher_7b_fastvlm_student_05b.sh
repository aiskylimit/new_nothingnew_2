#!/usr/bin/env bash
# Run all baselines sequentially for Qwen2-VL-7B teacher and FastVLM-0.5B student.
set -euo pipefail

SCRIPT_DIR="$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_DIR="$(cd -- "${SCRIPT_DIR}/.." && pwd)"
PAIR_DIR="${SCRIPT_DIR}/qwen2_teacher_7b_fastvlm_student_05b"
export PROJECT_DIR
...
printf '\nAll baselines completed successfully for qwen2_teacher_7b_fastvlm_student_05b.\n'
