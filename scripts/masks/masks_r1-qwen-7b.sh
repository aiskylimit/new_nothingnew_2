#!/usr/bin/env bash
# Phase 4: build masks for the DeepSeek-R1-Distill-Qwen-7B track (--vanilla emits both train-vanilla and train-spectral).
set -euo pipefail
...
echo "${CMD}"
${CMD} 2>&1 | tee logs/r1-qwen-7b-masks.log
