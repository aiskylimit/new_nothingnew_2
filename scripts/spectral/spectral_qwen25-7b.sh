#!/usr/bin/env bash
# Phase 5: masked SFT -- spectral, Qwen2.5-7B-Instruct track (LoRA, DDP across both GPUs).
# Byte-identical to sft_qwen25-7b.sh apart from DATA_PATH/OUTPUT_DIR: the A/B is the mask only.
set -euo pipefail
