...
class CustomScriptArguments(ScriptArguments):
    ...
    run_config: str = field(
        default=None,
        metadata={
            "help": "Local run name appended to output_dir. If omitted, a name is generated from hyperparameters."
        },
    )
...
if __name__ == "__main__":
    ...
    print(f"Using attention implementation: {model_args.attn_implementation or 'sdpa'}")
    print(f"{'='*80}\n")
