...
TROPIC-P/OPSD (see scripts/run_full_experiment_4b.py), EXCEPT for the base
model (Qwen/Qwen3-8B here, not 4B - this is the offline_rlsd_sdpo_b200 8B
variant, copied from run_rlsd_experiment_4b.py). Same LoRA config
(r=64, alpha=128, same target modules),
...
parser.add_argument("--output-dir", default="results_rlsd_8b",
