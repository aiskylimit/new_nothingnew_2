#!/usr/bin/env bash
# Phase 2: data prep (LIMO) -- DeepSeek-R1-Distill-Qwen-7B track.
set -euo pipefail
...
OUTPUT_PATH="data/r1-qwen-7b/train-segmented.jsonl"
N_SAMPLES="${N_SAMPLES:-}"
...
echo "${CMD}"
${CMD} 2>&1 | tee logs/r1-qwen-7b-data.log
